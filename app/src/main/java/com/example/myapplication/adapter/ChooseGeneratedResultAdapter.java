...
public class ChooseGeneratedResultAdapter extends RecyclerView.Adapter<ChooseGeneratedResultAdapter.GeneratedResultViewHolder>{
    ...
    public ChooseGeneratedResultAdapter(List<GeneratedResult> generatedResults, Context context) {
    ...
    public GeneratedResultViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_choose_generate, parent, false);
        return new GeneratedResultViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull GeneratedResultViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.chooseGeneratedResult.setChecked(selectedPosition == position);
        holder.chooseGeneratedResult.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    public class GeneratedResultViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        CheckBox chooseGeneratedResult;
        TextView tvTimestamp;

        public GeneratedResultViewHolder(View view) {
            super(view);
            resultImageView = view.findViewById(R.id.imgResult);
            chooseGeneratedResult = view.findViewById(R.id.cbChoose);
            tvTimestamp = view.findViewById(R.id.tvTimestamp);
            chooseGeneratedResult.setOnClickListener(this);
